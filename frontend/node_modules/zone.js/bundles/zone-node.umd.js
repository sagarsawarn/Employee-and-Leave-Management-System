 ...
 */ (function (g, f) { if (typeof define == "function" && define.amd) {
        ...
        Zone2.__load_patch("ZoneAwarePromise", function (global2, Zone3, api) {
                ...
                if (promise[symbolState] === UNRESOLVED) {
                    ...
                    if (state !== REJECTED && value instanceof ZoneAwarePromise && Object.hasOwn(value, symbolState) && Object.hasOwn(value, symbolValue) && value[symbolState] !== UNRESOLVED) {
                        ...
                        if (state === REJECTED && value instanceof Error) {
                            var trace = Zone3.currentTask && Zone3.currentTask.data && Zone3.currentTask.data[creationTrace];
                            if (trace) {
            ...
            function clearRejectedNoCatch(promise) {
                if (promise[symbolState] === REJECTED_NO_CATCH) {
                    try {
                        var handler = Zone3[REJECTION_HANDLED_HANDLER];
    ...
    function patchToString(Zone2) {
        Zone2.__load_patch("toString", function (global2) {
    ...
    function patchEvents(Zone2) {
        Zone2.__load_patch("EventEmitter", function (global2, Zone3, api) {
    ...
    function patchFs(Zone2) {
        Zone2.__load_patch("fs", function (global2, Zone3, api) {
            var _a;
            var fs;
            try {
                fs = require("fs");
    ...
    function patchNodeUtil(Zone2) {
        Zone2.__load_patch("node_util", function (global2, Zone3, api) {
    ...
    function patchNode(Zone2) {
        ...
        patchEvents(Zone2);
        patchFs(Zone2);
        Zone2.__load_patch("node_timers", function (global2, Zone3) {
        ...
        Zone2.__load_patch("nextTick", function () {
        ...
        Zone2.__load_patch("handleUnhandledPromiseRejection", function (global2, Zone3, api) {
        ...
        Zone2.__load_patch("crypto", function () {
            var crypto;
            try {
        ...
        Zone2.__load_patch("console", function (global2, Zone3) {
            var consoleMethods = [
                "dir",
                "log",
                "info",
            ...
            consoleMethods.forEach(function (m) {
                var originalMethod = console[Zone3.__symbol__(m)] = console[m];
                if (originalMethod) {
                    console[m] = function () {
        ...
        Zone2.__load_patch("queueMicrotask", function (global2, Zone3, api) {
