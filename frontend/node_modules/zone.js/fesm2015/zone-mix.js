...
function patchEvents(Zone3) {
  Zone3.__load_patch("EventEmitter", (global2, Zone4, api) => {
...
function patchFs(Zone3) {
  Zone3.__load_patch("fs", (global2, Zone4, api) => {
    var _a;
    let fs;
    try {
      fs = __require("fs");
...
function patchNodeUtil(Zone3) {
  Zone3.__load_patch("node_util", (global2, Zone4, api) => {
    api.patchOnProperties = patchOnProperties;
    api.patchMethod = patchMethod;
    api.bindArguments = bindArguments;
    api.patchMacroTask = patchMacroTask;
...
function patchNode(Zone3) {
  ...
  patchEvents(Zone3);
  patchFs(Zone3);
  Zone3.__load_patch("node_timers", (global2, Zone4) => {
  ...
  Zone3.__load_patch("handleUnhandledPromiseRejection", (global2, Zone4, api) => {
  ...
  Zone3.__load_patch("console", (global2, Zone4) => {
    ...
    consoleMethods.forEach((m) => {
      const originalMethod = console[Zone4.__symbol__(m)] = console[m];
      if (originalMethod) {
        console[m] = function() {
