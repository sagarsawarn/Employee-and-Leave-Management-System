...
function AdminLoginComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminLoginComponent_Conditional_12_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " Email is required. ");
  }
}
function AdminLoginComponent_Conditional_12_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function AdminLoginComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, AdminLoginComponent_Conditional_12_Conditional_1_Template, 1, 0)(2, AdminLoginComponent_Conditional_12_Conditional_2_Template, 1, 0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var AdminLoginComponent = class _AdminLoginComponent {
    ...
    this.auth.login(this.form.getRawValue()).subscribe({
      next: (res) => {
        ...
        if (res.data.user.role !== "admin") {
          this.auth.logout();
          this.serverError.set("This account is not an administrator. Use the regular sign-in page.");
          return;
        }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AdminLoginComponent, selectors: [["app-admin-login"]], decls: 24, vars: 10, consts: [[1, "login-wrap"], [1, "card", "login-card"], [1, "login-title"], [1, "text-muted", "login-sub"], ["role", "alert", 1, "alert", "alert-danger"], ["novalidate", "", 3, "ngSubmit", "formGroup"], [1, "form-group"], ["for", "email", 1, "form-label"], ["id", "email", "type", "email", "formControlName", "email", "autocomplete", "username", 1, "form-control"], [1, "text-danger", "field-error"], ["for", "password", 1, "form-label"], ["id", "password", "type", "password", "formControlName", "password", "autocomplete", "current-password", 1, "form-control"], ["type", "submit", 1, "btn", "btn-primary", "btn-block", 3, "disabled"], [1, "text-muted", "alt-link"], ["routerLink", "/login"]], template: function AdminLoginComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h1", 2);
      \u0275\u0275text(3, "Administrator sign-in");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "p", 3);
      \u0275\u0275text(5, "Restricted to admin accounts");
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(6, AdminLoginComponent_Conditional_6_Template, 2, 1, "div", 4);
      ...
      \u0275\u0275conditionalCreate(12, AdminLoginComponent_Conditional_12_Template, 3, 1, "div", 9);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(13, "div", 6)(14, "label", 10);
      \u0275\u0275text(15, "Password");
      \u0275\u0275elementEnd();
      \u0275\u0275element(16, "input", 11);
      \u0275\u0275conditionalCreate(17, AdminLoginComponent_Conditional_17_Template, 2, 0, "div", 9);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(18, "button", 12);
      \u0275\u0275text(19);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(20, "p", 13);
      \u0275\u0275text(21, " Not an admin? ");
      \u0275\u0275elementStart(22, "a", 14);
      \u0275\u0275text(23, "Employee sign-in");
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(6);
      ...
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", ctx.loading() ? "Signing in\u2026" : "Sign in as admin", " ");
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AdminLoginComponent, [{
    type: Component,
    args: [{ selector: "app-admin-login", standalone: true, imports: [CommonModule, ReactiveFormsModule, RouterLink], template: `<div class="login-wrap">
  <div class="card login-card">
    <h1 class="login-title">Administrator sign-in</h1>
    <p class="text-muted login-sub">Restricted to admin accounts</p>
    ...
    <p class="text-muted alt-link">
      Not an admin? <a routerLink="/login">Employee sign-in</a>
    </p>
  </div>
</div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AdminLoginComponent, { className: "AdminLoginComponent", filePath: "src/app/features/auth/admin-login.component.ts", lineNumber: 28 });
})();
export {
  AdminLoginComponent
};
//# sourceMappingURL=chunk-WKWZRDSF.js.map
